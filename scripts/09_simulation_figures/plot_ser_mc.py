...
parser.add_argument("--integrator", choices=("euler_spherical", "cayley"),
                    ...
                    help="LLG step type: 'euler_spherical' (default; fig 2.11 was generated "
                         "with it. NB fig 2.9/plot_single_trajectory.py instead uses the "
                         "driver default 'cayley' — this fig 2.9-Cayley / fig 2.11-Euler "
...
plt.close()
# Sync to vgsot-sim/article/figs/ (the canonical chapter copy)
