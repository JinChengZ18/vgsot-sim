...
![sMTJ温度效应和非理想性建模总览](figures/fig_03_thermal_nonidealities.png)
...
![瞬态热演化仿真结果](figures/fig_04_thermal_transients.png)
...
![温度依赖材料参数与TMR偏压响应](figures/fig_05_material_params.png)
...
![自热反馈对纯SOT翻转轨迹的影响](figures/fig_06_self_heating_trajectory.png)
...
![vgsot-sim三层架构示意](figures/fig_07_vgsot_sim_architecture.png)
...
![单次m_z与R_MTJ演化事件](figures/fig_08_single_trajectory.png)
...
![单次磁化矢量在单位球面上的三维轨迹](figures/fig_09_3d_trajectory.png)
...
![Monte Carlo Psw扫描结果](figures/fig_10_ser_mc.png)
